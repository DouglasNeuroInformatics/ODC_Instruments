      ...
      if (downDebounce === true) {
        ...
        if (highlightEl) {
          ...
          // SVG elements
            ...
            ['circle', 'rect', 'ellipse', 'line', 'path', 'polygon', 'polyline', 'image', 'text'].includes(
...
function showAlert(alertMessage, alertButtonText, action, fontSize, timeout, useSpaceBar, hideCursor) {
  var alertBox, alertContent, alertButton, alertSpaceBar, bodyCursorStyle, buttonCursorStyle;
