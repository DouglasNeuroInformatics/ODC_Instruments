      ...
      d = (function (a) {
        ...
        function i(a, b, c) {
          function d() {
            ...
            return g[z](f)
              ? (h(i, f), c ? c(g[f]) : g[f])
              : (i.length >= 1e3 && delete g[i.shift()], i.push(f), (g[f] = a.apply(b, e)), c ? c(g[f]) : g[f]);
          }
          return d;
        }
        ...
        var W = function (a) {
          ...
          $ = function (a, b, d) {
            if (
              (null == b && e(a, 'object') && 'r' in a && 'g' in a && 'b' in a && ((d = a.b), (b = a.g), (a = a.r)),
              null == b && e(a, string))
            ) {
              var f = c.getRGB(a);
              ((a = f.r), (b = f.g), (d = f.b));
        ...
        ((c._.getSomeDefs = o),
            ...
            for (var a in V)
              if (V[z](a)) {
                ...
                (('svg' != b.type && !c.ownerSVGElement) ||
                  ('svg' == b.type && (!c.parentNode || ('ownerSVGElement' in c.parentNode && !c.ownerSVGElement)))) &&
                  delete V[a];
              }
          }, 1e4),
          ...
          (c.fragment = function () {
            for (
              var a = Array.prototype.slice.call(arguments, 0), b = y.doc.createDocumentFragment(), d = 0, e = a.length;
              e > d;
              d++
            ) {
              var f = a[d];
          ...
          b.on('snap.util.getattr', function () {
            ...
            return ba[z](c)
              ? this.node.ownerDocument.defaultView.getComputedStyle(this.node, null).getPropertyValue(c)
              : d(this.node, a);
          }));
        var ba = {
    ...
    return (
      d.plugin(function (c, d, e, f, g) {
        ...
        function i(a) {
          ...
          for (
            var e, f = a.selectAll('*'), g = /^\s*url\(("|'|)(.*)\1\)\s*$/, h = [], i = {}, j = 0, k = f.length;
            k > j;
            j++
          ) {
        ...
        ((k.transform = function (a) {
          ...
          (k.marker = function (a, b, c, d, e, f) {
            ...
            return (
              ...
              l(a, 'object') &&
                'x' in a &&
                ((b = a.y), (c = a.width), (d = a.height), (e = a.refX || a.cx), (f = a.refY || a.cy), (a = a.x)),
              o(g.node, {
                viewBox: [a, b, c, d].join(' '),
                markerWidth: c,
                markerHeight: d,
      ...
      d.plugin(function (a, c, d, e, f) {
        ...
        ((a.deurl = function (a) {
          ...
          (function (a) {
            ...
            if (a instanceof c || a instanceof f) {
              ...
              (d || ((d = k('clipPath', n(this))), d.node.appendChild(a.node), !d.node.id && p(d.node, { id: d.id })),
        ...
        (b.on('snap.util.grad.parse', function (a) {
          ...
          b.on('snap.util.attr.viewBox', function (a) {
            var c;
            ((c =
              m(a, 'object') && 'x' in a ? [a.x, a.y, a.width, a.height].join(' ') : m(a, 'array') ? a.join(' ') : a),
      ...
      d.plugin(function (c, d, e, f, g) {
        ...
        ((h.rect = function (a, b, c, d, e, f) {
          ...
          return (
            ...
            i(a, 'object') && '[object Object]' == a
              ? (g = a)
              : null != a && ((g = { x: a, y: b, width: c, height: d }), null != e && ((g.rx = e), (g.ry = f))),
            this.el('rect', g)
          );
        }),
          (h.circle = function (a, b, c) {
            var d;
            return (
              i(a, 'object') && '[object Object]' == a ? (d = a) : null != a && (d = { cx: a, cy: b, r: c }),
              this.el('circle', d)
            );
          }));
        var j = (function () {
        ...
        ((h.image = function (a, b, d, e, f) {
          ...
          (h.ellipse = function (a, b, c, d) {
            var e;
            return (
              i(a, 'object') && '[object Object]' == a ? (e = a) : null != a && (e = { cx: a, cy: b, rx: c, ry: d }),
              this.el('ellipse', e)
            );
          }),
          (h.path = function (a) {
          ...
          (function () {
            ...
            function g(a) {
              var d = a,
                e = this.stops();
              if (
                ('string' == typeof a && (d = b('snap.util.grad.parse', null, 'l(0,0,0,1)' + a).firstDefined().stops),
                c.is(d, 'array'))
              ) {
      ...
      d.plugin(function (a, b, c, d) {
        ...
        function B(b) {
          ...
          for (
            ...
            if ((f.push((n = [])), (o = b[q]), (d = o[0]), d != d.toUpperCase()))
              ...
              ((s = [i, j].concat(o.slice(1))), f.pop(), (f = f.concat(I(s, p))), (n = ['R'].concat(o.slice(-2))));
        ...
        function F(a, b, c, d, e, f, g, h) {
          for (var i, j, k, l, m, n, o, p, q = [], r = [[], []], s = 0; 2 > s; ++s)
            if (
              (0 == s
                ? ((j = 6 * a - 12 * c + 6 * e), (i = -3 * a + 9 * c - 9 * e + 3 * g), (k = 3 * c - 3 * a))
                : ((j = 6 * b - 12 * d + 6 * f), (i = -3 * b + 9 * d - 9 * f + 3 * h), (k = 3 * d - 3 * b)),
              U(i) < 1e-12)
            ) {
          ...
          return (
            ...
            { min: { x: R.apply(0, r[0]), y: R.apply(0, r[1]) }, max: { x: S.apply(0, r[0]), y: S.apply(0, r[1]) } }
          );
        }
        function G(a, b) {
          var c = !b && e(a);
        ...
        ((j.push = function () {
          ...
          (j.getBBox = function () {
            ...
            return (
              ...
              (c = g.apply(0, c)),
              (d = g.apply(0, d)),
              { x: a, y: b, x2: c, y2: d, width: c - a, height: d - b, cx: a + (c - a) / 2, cy: b + (d - b) / 2 }
            );
          }),
          (j.clone = function (a) {
            a = new i();
              ...
              function (c, d) {
                if (a.is(c, 'function'))
                  ((this.events = this.events || []),
                    this.events.push({ name: b, f: c, unbind: n(this.node || document, b, c, d || this) }));
                else
