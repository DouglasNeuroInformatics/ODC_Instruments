...
export function render(done) {
  ...
  var clickHandler = function (e) {
    ...
    if (clicks === numTargets) {
      ...
      if (frame.type === 'test') {
        ...
        var msg = '<br><br><br><br>You got ' + targetClicks + ' of ' + numTargets + ' dots correct.<br><br><br>';
      ...
      if (motionTimer === animationFrames - 1) {
        ...
        if (frame.type === 'practice' || frame.type === 'test') {
          ...
          timeoutRef = setTimeout(function () {
            ...
            showAlert(
              'You took too long to respond!<br><br>' +
          ...
          if (frame.type === 'practice')
            getID('textMiddle').innerHTML = 'Click the ' + numTargets + ' dots that flashed!';
          else if (frame.type === 'test') getID('textMiddle').innerHTML = 'Click ' + numTargets + ' dots';
        } else
          setTimeout(function () {
            nextTrial();
          }, 1500);
  ...
  function setFrameSequence() {
    var testMessage = {
      begin: '<h2>Splitting Your Attention</h2>' + '<img src=MOT.gif><br><br>',
      instruction1:
        '<h2>Instructions:</h2>' +
      ...
      practice3: '<br><br><br>Good!<br><br>' + "Now we'll do the same thing with<br>" + '3 flashing dots.<br><br>',
      targets3:
        '<br><br>Great!<br><br>' +
      ...
      targets5:
        ...
        'Every smile you click adds to your score!<br><br>',
      emaTargets5:
        'You will do this task <br>' +
        'with 5 flashing dots!<br>' +
        'Motion is slow at first, then gets faster.<br><br>' +
        'When you lose track of dots, just guess.<br>' +
        'Every smile you click adds to your score!<br><br>',
      noprac: 'Remember:<br><br>' + 'Click on the dots with the green <br>' + 'smiley faces behind them.<br><br>'
    };
