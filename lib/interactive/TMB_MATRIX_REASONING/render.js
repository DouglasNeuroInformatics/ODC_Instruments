...
export function render(done) {
  ...
  function setFrameSequence() {
    ...
    // messages
    testMessage = {
      begin: '<h2>Visual Patterns</h2>' + "<img src='images/example1.png'><br><br>",
      instructions: [
        '<h3>Instructions:</h3>' +
  ...
  function parseFile(text) {
    ...
    if (text) {
      ...
      if (errors) {
        ...
        images = images.concat(imagePairs.pluck('choice1')).concat(imagePairs.pluck('choice2'));
        images = images.concat(imagePairs.pluck('choice3')).concat(imagePairs.pluck('choice4'));
        images = images.concat(imagePairs.pluck('choice5'));
        images = images.concat(['example1.png', 'example2.png', 'example3.png']);
        images = images.concat(['1.png', '1-1.png', '1-2.png', '1-3.png', '1-4.png', '1-5.png']);
  ...
  (function () {
    ...
    if (!stoppingRule || stoppingRule === 'true') {
      ...
      showAlert(
        "Error: Invalid value for url parameter 'stoppingRule'<br><br>" + "Must be 'true' or 'false'<br><br>",
        '',
        null,
        '20pt'
      );
