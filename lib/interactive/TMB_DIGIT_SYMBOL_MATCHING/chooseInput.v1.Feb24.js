...
function chooseInput(inputTypes, callback) {
  ...
  els = [
    ...
    },
    {
      ...
      es: ' no es válido para esta prueba: intente con otra entrada.',
      fr: ' non valide pour ce test: essayez une autre entrée.',
      zh: ' not valid for this test: try another input.',
      'zh-hk': ' not valid for this test: try another input.',
      nl: ' niet mogelijk voor deze taak, probeer een andere reactiemethode.'
    },
    {
      en: '<h3>Please click here<br>to choose how you will<br>respond in this test.</h3>', // 5
      ...
      zh: '<h3>Please click here<br>to choose how you will<br>respond in this test.</h3>',
      'zh-hk': '<h3>Please click here<br>to choose how you will<br>respond in this test.</h3>',
      nl: '<h3>Klik hier om te bepalen hoe<br>je in deze test wil reageren.</h3>'
    },
    {
      ...
      zh: '- To use a <b>keyboard</b>, <b>press any key</b> now.<br><br>',
      'zh-hk': '- To use a <b>keyboard</b>, <b>press any key</b> now.<br><br>',
      nl: '- Om het <b>toetsenbord</b> te gebruiken, <b>druk nu op een toets</b><br><br>'
    },
    {
      ...
      zh: '- To use a <b>mouse</b> or <b>trackpad</b>, <b>click here</b> now.<br><br>',
      'zh-hk': '- To use a <b>mouse</b> or <b>trackpad</b>, <b>click here</b> now.<br><br>',
      nl: '- Om je <b>muis</b> of <b>trackpad</b> te gebruiken, <b>klik nu</b> hier.<br><br>'
    },
    {
      ...
      zh: '- To use a <b>touch screen</b>, <b>touch here</b> now.<br><br>',
      'zh-hk': '- To use a <b>touch screen</b>, <b>touch here</b> now.<br><br>',
      nl: '- Om je <b>touch screen</b> te gebruiken, <b>raak dit</b> aan.<br><br>'
    }
  ];
  ...
  function getinput(e) {
    ...
    if (input) {
      ...
      if ('ontouchend' in window || navigator.maxTouchPoints || navigator.msMaxTouchPoints)
        document.removeEventListener('touchend', getinput, true);
      document.removeEventListener('mouseup', getinput, true);
      if (window.PointerEvent) document.removeEventListener('pointerup', getinput, true);
      else if (window.MSPointerEvent) document.removeEventListener('MSPointerUp', getinput, true);
  ...
  function setup() {
    ...
    if ('ontouchend' in window || navigator.maxTouchPoints || navigator.msMaxTouchPoints)
      document.addEventListener('touchend', getinput, true);
    if (window.PointerEvent) document.addEventListener('pointerup', getinput, true);
    else if (window.MSPointerEvent) document.addEventListener('MSPointerUp', getinput, true);
  }

  function trigger() {
    msg = '';
    if (inputTypes.keyboard) msg += els[6][lang];
    if (inputTypes.mouse) msg += els[7][lang];
    if (inputTypes.touch) msg += els[8][lang];
